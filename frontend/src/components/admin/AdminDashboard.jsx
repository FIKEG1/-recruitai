...
const AdminDashboard = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            // Fetch summary report from the reports API with token
            ...
            setStats({
                totalUsers: reportData.summary?.totalUsers || 0,
                totalJobs: reportData.summary?.totalJobs || 0,
                totalApplications: reportData.summary?.totalApplications || 0,
                totalResumes: 0,
                ...
                summary: {
                    ...
                    totalEmployers: reportData.summary?.totalEmployers || 0,
                    totalJobSeekers: reportData.summary?.totalJobSeekers || 0
                }
            });
            
            // If we got data, remove any error
            if (reportData) {
                setError('');
            }
            ...
            // Set fallback data so the dashboard still looks nice
            setStats({
                totalUsers: 0,
                totalJobs: 0,
                totalApplications: 0,
        ...
        datasets: [
            {
                ...
                backgroundColor: stats.statusBreakdown?.length > 0 ? [
                    '#f39c12', // pending - yellow
                    '#3498db', // reviewed - blue
                    '#27ae60', // shortlisted - green
                    '#2980b9', // interviewed - dark blue
                    '#2ecc71', // offered - light green
                    '#e74c3c'  // rejected - red
                ] : ['#ccc'],
                borderWidth: 2,
                borderColor: '#fff'
...
© ${new Date().getFullYear()} Sidama Innovation and Technology Agency
    ...
    return (
        <section className="admin-dashboard py-4">
            <Container>
                {/* Header */}
                <div className="d-flex flex-wrap justify-content-between align-items-center mb-4">
                    ...
                    <div className="d-flex gap-2">
                        <Button variant="primary-gradient" onClick={exportReport}>
                ...
                <Row className="g-3 mb-4">
                    ...
                    <Col md={3} sm={6}>
                        <Card className="dashboard-card" style={{ borderLeftColor: '#4CAF50' }}>
                            <Card.Body>
                                <div className="d-flex justify-content-between align-items-center">
                                    <div>
                                    ...
                                    <div className="icon text-success" style={{ fontSize: '2rem' }}>
                                        <FaBriefcase />
                                    </div>
                                </div>
                            </Card.Body>
