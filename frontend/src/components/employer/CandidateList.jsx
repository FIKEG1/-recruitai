        ...
        <section className="candidate-list-page py-5 bg-light min-vh-100">
            <Container>
                ...
                <div className="mb-5 text-center text-md-start">
                    <h1 className="fw-bold text-dark">Find Top Talent</h1>
                    <p className="text-muted fs-5">Browse {pagination.totalCandidates} top-rated Ethiopian professionals ready to work.</p>
                </div>
